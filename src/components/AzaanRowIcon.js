...
const PATH_WAVE_INNER =
  'M15.9978 8.99878C16.6469 9.86426 16.9978 10.9169 16.9978 11.9988C16.9978 13.0806 16.6469 14.1333 15.9978 14.9988';

const PATH_WAVE_OUTER =
  'M19.3613 18.3615C20.197 17.5259 20.8598 16.5339 21.312 15.4421C21.7643 14.3503 21.997 13.1801 21.997 11.9984C21.997 10.8166 21.7643 9.64647 21.312 8.55468C20.8598 7.46289 20.197 6.47087 19.3613 5.63525';

const STROKE = 1.99973;
const WAVE_STROKE = '#FDFDFF';

/** Figma export — 24×24 speaker / Azaan (settings row) */
export default function AzaanRowIcon({ size = 24 }) {
  return (
